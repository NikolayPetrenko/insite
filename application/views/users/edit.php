    ...
    <form action="<?php echo URL::site('users/edit') ?>" method="POST" id="user-edit">
        <table class="table table-bordered table-striped">
                <tbody>
                        ...
                        <tr>
                            <td><label>Пароль на вашем компьютере</label></td>
                            <td>
                                <div class="input-prepend">
                                    <span class="add-on">&nbsp;</span>
                                    <input class="span2" id="twitter" name="user[pc_password]" type="text" placeholder="password" value="<?php echo $user->pc_password ?>">
                                </div>
                            </td>
                        </tr>
                        <tr>
